    ...
    <div className=" text-white p-8 lg:p-12 max-w-4xl mx-auto font-sans">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg leading-relaxed text-gray-300">
          At <strong className="text-violet-400">Mind Help</strong>, our mission is to promote mental well-being and empower individuals on their journey to mental health. We believe that everyone deserves access to the tools and support needed to navigate life's challenges and foster emotional resilience.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg leading-relaxed text-gray-300">
          <strong className="text-violet-400">Mind Help</strong> is a dedicated team of mental health professionals, developers, and advocates who are passionate about making mental health resources accessible to all. We understand the importance of mental well-being and are committed to creating a safe and supportive space where individuals can express themselves freely and seek help without stigma.
        </p>
      </section>
